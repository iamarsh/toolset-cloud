...
const workflows = [
  {
    name: 'AI Rewriter',
    description: 'Save tone presets for consistent brand voice',
    icon: Sparkles,
    href: '/tools/ai-rephraser',
    tier: 'Account',
  },
  {
    name: 'JSON → CSV',
  ...
  {
    name: 'OCR',
    description: 'Save output templates for structured data',
    icon: FileImage,
    href: '/tools/ocr',
    tier: 'Pro',
  },
  {
    ...
    description: 'Save brand voice for social media posts',
    icon: User,
